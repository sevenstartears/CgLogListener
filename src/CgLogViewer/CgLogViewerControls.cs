...
{
    public class CgLogViewerCheckBox : CheckBox, INotifyMessage
    {
    ...
    public class CgLogViewerTrackBar : TrackBar
    {
        public string NameInSetting { get; set; }
    }

    public class CgLogViewerListBox : ListBox, INotifyMessage
    {
